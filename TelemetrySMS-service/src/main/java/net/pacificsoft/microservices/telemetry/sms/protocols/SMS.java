...
public class SMS {
    ...
    List<String> Epoch_time_sent = new ArrayList();
...
//    Boolean Sabotage_Valve = false;
    ...
    public SMS(ReadSMS sms_reader , String sms) {
        ...
        Batery_level.add (String.valueOf(ConverterSms.SimpleConverterToAscii(Batery_level.get(1),sms_reader,sms_reader.getProtocol().getSmsData().getSignature().getBateryLevel().getOffset())/10));
        ...
        NotifyCycleH.add (String.valueOf(ConverterSms.SimpleConverterToAscii(NotifyCycleH.get(1),sms_reader,sms_reader.getProtocol().getSmsData().getSignature().getNotifyCycleH().getOffset())));
        ...
        Online_time.add (String.valueOf(ConverterSms.SimpleConverterToAscii(Online_time.get(1),sms_reader,sms_reader.getProtocol().getSmsData().getSignature().getOnlineTime().getOffset())));
        ...
        String st1 = String.valueOf(ConverterSms.SimpleConverterToAscii(Send_time.get(1).substring(0,1),sms_reader,sms_reader.getProtocol().getSmsData().getSignature().getSendTime().getOffset()));
        String st2 = String.valueOf(ConverterSms.SimpleConverterToAscii(Send_time.get(1).substring(1,2),sms_reader,sms_reader.getProtocol().getSmsData().getSignature().getSendTime().getOffset()));
        Send_time.add (st1+":"+st2);
        ...
        Gsm_Signal.add (String.valueOf(ConverterSms.SimpleConverterToAscii(Gsm_Signal.get(1),sms_reader,sms_reader.getProtocol().getSmsData().getSignature().getGsmSignal().getOffset())));

        Epoch_time_sent.add (sms_reader.getProtocol().getSmsData().getSignature().getEpoch().getName());
        Epoch_time_sent.add (sms.substring(sms_reader.getProtocol().getSmsData().getSignature().getEpoch().getPosSMS(),sms_reader.getProtocol().getSmsData().getSignature().getEpoch().getPosSMS() + sms_reader.getProtocol().getSmsData().getSignature().getEpoch().getLength()));
        Epoch_time_sent.add (ConverterSms.EpochConverter(Epoch_time_sent.get(1)).toString());
    ...
    public String toString() {
        return "SMS{" +
                ...
                "\n"+ANSI_RED+"Epoch Time Sent ==> " +ANSI_RESET + ANSI_BLUE + Epoch_time_sent.get(0) + ": " + ANSI_RESET + Epoch_time_sent.get(2) +
